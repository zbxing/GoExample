...
const manifest = {
  ...
  inputs: [
    ...
    'Proj/Example/go.mod',
    'Proj/Example/go.sum',
    'Proj/Example/cmd/server/main.go',
    'Proj/Example/cmd/server/main_test.go',
    'Proj/Example/internal/projectapi/routes.go',
    'Proj/Example/internal/projectapi/routes_test.go',
    'Proj/Example/internal/projectapi/openapi_contract_test.go',
    'Proj/Example/internal/projectapi/transport_benchmark_test.go',
	'Proj/Example/internal/projectapp/service.go',
	'Proj/Example/internal/projectapp/service_test.go',
	'Proj/Example/internal/projectapp/authorization.go',
	'Proj/Example/internal/projectapp/authorization_test.go',
